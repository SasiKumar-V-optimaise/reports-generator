...
from src.infrastructure.config.caster_config_resolver import resolve_enabled_casters


logger = logging.getLogger("reports.video.video_overlay")
...
class ShiftVideoOverlayGenerator:
    ...
    def __init__(
        ...
        output_dir = self.video_cfg.get("overlay_output_dir", "outputs/overlay-videos")
